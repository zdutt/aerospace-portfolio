...
export default function AboutPage() {
  ...
  return (
    <main className="container mx-auto space-y-8">
      {/* One card wrapping all About content for a cleaner layout */}
      <section className="rounded-2xl border border-white/10 p-6 md:p-8 shadow-xl shadow-white/5">
      ...
      {/* Timeline bubble (heading removed for redundancy) */}
      <section className="rounded-2xl border border-white/10 p-6 md:p-8 shadow-xl shadow-white/5">
